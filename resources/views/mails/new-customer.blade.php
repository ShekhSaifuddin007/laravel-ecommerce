                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="es-infoblock esd-block-text es-m-txt-c" align="right">
                                                                <p><a href="http://#" target="_blank" style="font-family: 'arial', 'helvetica neue', 'helvetica', 'sans-serif';"></a><br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="520" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image" align="center" style="padding: 25px">
                                                                <a href="#" style="color: #fff; text-decoration: none; font-size: 30px; font-weight: bold;">Ecommers App</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <tr>
                                    <td class="esd-structure esd-checked es-p40t es-p40b es-p40r es-p40l" style="background-image: url('https://tlr.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/93491522393929597.png'); background-repeat: no-repeat;" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="520" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0" style="padding: 50px">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" class="esd-block-text es-p40t es-p10b">
                                                                <h1 style="color: #ffffff;">WELCOME {{ $customer->user_name }}</h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p10t es-p20b" align="center">
                                                                <span class="es-button-border" style="background-color: #26a4d3; padding: 10px 15px; border-radius: 50px;">
                                                                    <a href="#" class="es-button" style="text-decoration: none; color: #fff; font-weight: bold;">ACCESS ACCOUNT</a>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image" align="left">
                                                                <a target="_blank"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_85e4431b39e3c4492fca561009cef9b5/images/29241521207598269.jpg" alt style="display: block;" width="40"> </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-social" align="center">
                                                                <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0" style="padding: 20px;">
                                                                    <tbody>
                                                                    <tr style="margin: 10px;">
                                                                        <td style="padding: 5px;" valign="top" align="center">
                                                                            <a href="#"><img title="Facebook" src="https://tlr.stripocdn.email/content/assets/img/social-icons/circle-white/facebook-circle-white.png" alt="Fb" width="24" height="24"></a>
                                                                        </td>
                                                                        <td style="padding: 5px;" valign="top" align="center">
                                                                            <a href="#"><img title="Twitter" src="https://tlr.stripocdn.email/content/assets/img/social-icons/circle-white/twitter-circle-white.png" alt="Tw" width="24" height="24"></a>
                                                                        </td>
                                                                        <td style="padding: 5px;" valign="top" align="center">
                                                                            <a href="#"><img title="Instagram" src="https://tlr.stripocdn.email/content/assets/img/social-icons/circle-white/instagram-circle-white.png" alt="Inst" width="24" height="24"></a>
                                                                        </td>
                                                                        <td style="padding: 5px;" align="center">
                                                                            <a href="#"><img title="Linkedin" src="https://tlr.stripocdn.email/content/assets/img/social-icons/circle-white/linkedin-circle-white.png" alt="In" width="24" height="24"></a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="520" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10b" align="center">
                                                                <p>Preferences | Browser | Forward | Unsubscribe</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-infoblock" align="center">
                                                                <a target="_blank" href="http://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=information&utm_content=trigger_newsletter4"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_9df86e5b6c53dd0319931e2447ed854b/images/64951510234941531.png" alt width="125"> </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
